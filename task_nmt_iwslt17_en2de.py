...
# bert配置
config_path = '/data/lidongxing/bert4keras-master2/models/multi_cased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/data/lidongxing/bert4keras-master2/models/multi_cased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/data/lidongxing/bert4keras-master2/models/multi_cased_L-12_H-768_A-12/vocab.txt'
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if logs['loss'] <= self.lowest:
            ...
            model.save_weights('./iwslt2017_en2de_model/best_model_deen.weights')
...
#     model.load_weights('./iwslt2017_en2de_model/best_model_deen.weights')
...
des = autotitle.generate('We need to develop a feminine discourse that not only honors but also implements mercy instead of revenge, collaboration instead of competition, inclusion instead of exclusion',topk=4)
print(des)
