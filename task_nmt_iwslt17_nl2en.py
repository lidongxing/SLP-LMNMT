...
ens = autotitle.generate("We moeten een vrouwelijk discours ontwikkelen dat niet alleen genade eert maar ook implementeert in plaats van wraak, samenwerking in plaats van competitie, inclusie in plaats van uitsluiting.",topk=4)
print(ens)
